...
''' MonthlyCorrelation script will do this:
    Correlate the external weather data (from OpenWeatherMap API) and internal farm conditions 
    (which is our live sensor data obtained from our deployed sensors) for the month & produce a heatmap of the result
'''

# PC_PATH = "daily power consumption.csv"
...
''' External Weather to Internal Conditions Correlation '''
...
#     csv_file_path = os.path.join(current_directory, "data", PC_CSV)
