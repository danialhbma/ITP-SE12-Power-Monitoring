...
# returns the power consumption of water pumps in kWh (watts * hours ran * racks used) / 1000
...
def get_racklight_power_consumption(light_mean_dict,
    ...
    purple_led_on_power = round((purple_led_on_mean * days_ran * hours_ran * purple_led_racks) / 1000, 2)
    purple_led_off_power = round((purple_led_off_mean * days_ran * (whole_day - hours_ran) * purple_led_racks) / 1000, 2)
    
    white_led_on_power = round((white_led_on_mean * days_ran * hours_ran * white_led_racks) / 1000, 2)
    white_led_off_power = round((white_led_off_mean * days_ran * (whole_day - hours_ran)) * white_led_racks / 1000, 2)
...
def get_aircon_power_consumption(days_ran,
    ...
    return round(total_watts * days_ran * num_of_hours_ran * num_of_units / 1000, 2)
